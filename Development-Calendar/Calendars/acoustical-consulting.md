# Professional Networking & Acoustical Consulting Calendar

[Category pathway](../Areas/acoustical-consulting.md) · [Master calendar](../README.md) · [Main portfolio](../../README.md)

[🟨 **Professional Networking & Acoustical Consulting**](../Areas/acoustical-consulting.md) · **Status:** ✓ **Recorded** · ◇ **Planned**

Exact dates are used for confirmed events. Repository and document additions use the date of the first relevant GitHub commit. Sessions, calls, and outreach use their recorded real-world dates. Entries describing multi-day strategy or procedure development are period-level records and do not imply that a particular file was created that day. Repeated networking-period entries indicate ongoing research and outreach rather than claiming that a specific conversation occurred on each date. The pathway includes acoustical consulting as well as professional relationships supporting automotive audio, DSP, critical listening, and portfolio development.
...
| **27** | **28** | **29** | **30** | [**31**](#networking-and-consulting-development-areas)<br>[🟨 **NET**](../Areas/acoustical-consulting.md)<br>✓ Technical outreach + Atmos request<br>◇ Tyrone growth-reference request | — | — |

### Month Objective

Develop a professional network across acoustical consulting and technical audio while using direct input to guide career research, portfolio priorities, and transferable technical development.

### Confirmed Events and Networking Context

- **July 14:** Reached out to **Ray Plasse**, Junior Consultant at Trinity Consultants. The information from that contact informed subsequent consulting-career research and planning.
- **July 14–24:** Researched consulting opportunities and networked with former classmates, professors, and professionals, including **Alek Weidman, George Lawson, Justin Roberts, and Lisa Lafountaine**. Individual dates are not assigned where they were not recorded.
- **July 20:** Scheduled an informational call with **Gus Campbell of Coffman Engineers** for that Friday.
- **July 23 onward:** Began gathering automotive-audio career and technical input from **Jay Krusac, Jonathan Ewald, Jamie Moericke, Sean Olive, and Rafael Kasier**; that input informed subsequent roadmapping and portfolio strategy.
...
**July 31 outreach record:** Contacted **Ray Plasse** for guidance on an acoustical-software study path, including free or accessible room-modeling tools comparable in purpose to CAD- or EASE-based consulting workflows and possible preparation for future room-mockup projects. In parallel, contacted **Alek Weidman** for guidance on an electrical-engineering self-study path that could extend the introductory studio-electronics work completed through Mike Porter’s course. Also contacted **George Lawson** to identify the architectural-modeling software used in a prior REW room-analysis project and ask whether he still has access to the original project files. George confirmed that the project used **SketchUp**. Recovery of the original SketchUp model, REW data, and related project files remains pending. Also contacted **Jon Lechner**, Kevin’s Belmont movie-mixing Dolby Atmos professor, to request a character/professional recommendation grounded in Kevin’s work across the course’s technical and creative film-mixing demands. The request was sent; no recommendation has yet been received. A separate **Tyrone Jackson** request is scheduled for July 31, focused on Kevin’s personal growth from being highly reserved toward greater confidence, openness, and pursuit of professional potential, informed by Tyrone’s own progression from a similar starting point into an established doctorate-level career as an Atlanta-area musician. This request remains planned until confirmed sent. Also contacted **Lisa LaFountaine** to identify and obtain contact information for the REM Studio B staff member who spent substantial time working with Kevin. If the correct person is identified and reachable, Kevin may request a studio-engineering recommendation based on her direct observation and professional experience; no such request has yet been sent. A recommendation email to **Ed Seay** has also been drafted and is ready, focused on Kevin’s engagement with critical listening, mixing, music and production history, and the evolution of studio technology. Ed’s email address was located, resolving the contact blocker. The completed request is ready for immediate delivery but remains marked unsent until Kevin confirms sending it.

# 02 — Perception & Critical Listening

## Function
Translate listener perception into repeatable observations, preference judgments, thresholds, attributes, and evaluation procedures.

## Knowledge being developed
Psychoacoustics; trained listening; experimental controls; stimulus design; rating methods; bias and uncertainty; statistical interpretation; automotive sound-quality evaluation.
...
## System connections
Defines perceptual targets for Buckets 01 and 05 and supplies subjective validation to Bucket 08. Bucket 10 supports stimulus generation and analysis.

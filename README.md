...
Relevant experience includes professional work at [Ocean Way Nashville](https://oceanwaynashville.com/) and [Starstruck Studios](https://www.starstruckentertainment.com/studios); guided work in 7.1.4 Dolby Atmos environments; the [Ocean Way immersive-recording independent study](Projects/Technical-Audio-and-Research/Ocean-Way-Jazz-Combo-Dolby-Atmos-Independent-Study/README.md); and participation as a listener—not an author—in the published AES studies [*Binaural Renderers Accuracy Comparison: Part I*](https://www.aes.org/e-lib/browse.cfm?elib=22327), [*Limits of the Cochlear Bandpass*](https://www.aes.org/e-lib/browse.cfm?elib=22317), and [*Detection of Phase Alignment and Polarity in Drum Tracks*](https://www.aes.org/e-lib/browse.cfm?elib=22248). Together, this supports my continued development as a trained critical listener for spatial, loudspeaker, and automotive-audio applications.

...
- **Pure Data — [Real-Time DSP Prototype](https://github.com/kevinworleymusic-afk/capture-to-reproduction-audio-study/blob/main/docs/01_Real-Time_DSP_Prototype_in_Pure_Data.md):** Implemented stereo playback, delay, filtering, gain, test signals, low-frequency routing, and protected output in two documented patch versions.
...
- **MATLAB — [Distortion and Audio Analysis](Projects/Coding-and-Audio-Software/MATLAB-Projects/MATLAB-Distortion-and-Audio-Analysis/README.md):** Waveshaping, clipping, bit-depth reduction, THD, stereo analysis, and spatial-processing exercises.
...
Additional experience includes instruction from [Ed Seay](https://aes.digitellinc.com/b/sp/ed-seay-3855), guided 7.1.4 Dolby Atmos listening, the [Ocean Way immersive study](Projects/Technical-Audio-and-Research/Ocean-Way-Jazz-Combo-Dolby-Atmos-Independent-Study/README.md), and listener—not author—participation in three published AES studies.

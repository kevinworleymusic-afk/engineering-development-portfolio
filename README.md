...
My critical-listening development began with extensive structured training through [SoundGym](https://www.soundgym.co/member/profile?m=byy1s26wj7u), producing a 3,410,130 SPI, Diamond Ears Award, and 9,491 completed training activities. SoundGym reports these activities as “games,” but they are auditory-training exercises and are not equivalent to 9,491 single trials; an activity may contain multiple listening judgments. I then completed Jason Corey’s technical-ear-training work in class and have continued using that method for additional structured practice. The current [Corey-method training record](https://github.com/kevinworleymusic-afk/technical-ear-training) contains 733 separately logged trials, including 97% across 30 two-band and 90% across 10 three-band EQ-matching trials, with task-specific limitations documented alongside the results.

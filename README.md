...
- **Listening software — [Technical Listening Trainer prototype](https://github.com/kevinworleymusic-afk/technical-listening-trainer):** Designed to support my own critical-listening development through highly customizable blind EQ exercises, with configurable conditions for approximating aspects of car-cabin listening, validated biquad processing, and CSV analytics.
...
- **Pure Data — [Real-Time DSP and Tuning-Workflow Prototype](https://github.com/kevinworleymusic-afk/capture-to-reproduction-audio-study/blob/main/docs/01_Real-Time_DSP_Prototype_in_Pure_Data.md):** My first practical step into the Audio Weaver concept-study track, pairing tutorial review with node-based playback, delay, filtering, gain, test signals, low-frequency routing, and protected output; implemented in Pure Data, not Audio Weaver.

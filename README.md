...
Use the **[Career Research Dashboard — Current Automotive, Acoustical Consulting, and Georgia Education Opportunities](https://docs.google.com/spreadsheets/d/1RuIrnG35fnQ2G6rblekq6ydcGVg35Rl4QB69DlzJnJY/edit)** to review verified current openings, target employers, fit and skill-gap notes, education-certification pathways, and the repeatable search process used to refresh opportunities over time.

The [Pure Data prototype](https://github.com/kevinworleymusic-afk/capture-to-reproduction-audio-study/blob/main/docs/01_Real-Time_DSP_Prototype_in_Pure_Data.md) is implemented; vehicle studies and hardware extensions remain planned, proposed, access-dependent, or conditional. Review the [development syllabus](SYLLABUS.md), [room-response project](Projects/Coding-and-Audio-Software/MATLAB-Projects/MATLAB-Impulse-Response-and-Audio-Systems-Analysis/README.md), [Audio Precision study](Projects/Technical-Audio-and-Research/Studer-A80-vs-A800-Plugin-Validation-Study/README.md), [generator/barrier noise-analysis plan](Projects/Technical-Audio-and-Research/Generator-to-Residence-Barrier-Noise-Analysis/), [automotive roadmap](https://github.com/kevinworleymusic-afk/capture-to-reproduction-audio-study/blob/main/docs/Future-Projects/02_Automotive_Audio_Implementation_Roadmap.md), and [networking and consulting calendar](Development-Calendar/Calendars/acoustical-consulting.md).

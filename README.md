...
Master’s-trained technical audio engineer developing applied experience across **acoustics and audio measurement, electroacoustic system validation, immersive and spatial audio, audio DSP, and technical software development**, with particular long-term interests in **automotive audio and in-cabin spatial-audio systems**. My professional foundation includes work as a **Student Staff Engineer at Ocean Way Nashville** and a **Studio Intern at Starstruck Entertainment**.
...
## Critical Listening, Music Education, and Immersive Experience

My [Technical Ear Training repository](https://github.com/kevinworleymusic-afk/technical-ear-training) documents structured software exercises, chapter-by-chapter progress, and the broader experience behind my development as a trained critical listener. A detailed, source-linked account is available in [Prior Listening and Ear-Training Experience](https://github.com/kevinworleymusic-afk/technical-ear-training/blob/main/PRIOR_EXPERIENCE.md).

- **Musical and educational foundation:** B.M. training in Jazz Performance and Music Education, including jazz study with [Sam Skelton](https://www.samskeltonmusic.com/), [Tyrone Jackson](https://tyronejackson.com/bio), and [Trey Wright](https://www.treywright.com/), plus student teaching and mentorship under [Dr. Robert Grogan](https://www.midwestclinic.org/2023_clinician_Robert_Grogan) and [Bradley Rikard](https://www.sprayberryband.com/banddirectors). This background supports pitch, harmony, timbre, intonation, ensemble balance, diagnostic listening, and communication of corrective feedback.
- **Graduate audio-engineering foundation:** M.S. study at Belmont with [Dr. Doyuen Ko](https://www.belmont.edu/profiles/doyuen-ko/), [Dr. Wesley Bulla](https://www.belmont.edu/profiles/wesley-bulla/), [Dr. Song Hui Chon](https://www.belmont.edu/profiles/song-hui-chon/), [Dr. Eric Tarr](https://www.belmont.edu/profiles/eric-tarr/), and [Michael Janas](https://www.belmont.edu/profiles/michael-janas/), with studio-focused instruction from [Ed Seay](https://aes.digitellinc.com/b/sp/ed-seay-3855) and introductory studio-maintenance instruction from [Mike Porter](https://www.namm.org/library/oral-history/mike-porter/).
- **Professional studio experience:** Student Staff Engineer experience across [Ocean Way Nashville](https://oceanwaynashville.com/)—including Studios [A](https://oceanwaynashville.com/pages/studio-a), [B](https://oceanwaynashville.com/pages/studio-b), [C](https://oceanwaynashville.com/pages/studio-c), [D](https://oceanwaynashville.com/pages/studio-d), and [The Lighthouse](https://oceanwaynashville.com/pages/the-lighthouse)—and internship experience across [Starstruck Studios](https://www.starstruckentertainment.com/studios), including The Gallery, The Pond, its isolation rooms, the 7.1.4 Atmos Studio, Mix Studio, Broadcast Studio, and Writer's Rooms.
- **Immersive listening and production:** Guided work in Belmont Atmos rooms, Starstruck's [7.1.4 Dolby Atmos Studio](https://www.starstruckentertainment.com/atmos), and Ocean Way Studio A; a Dolby Atmos film-mixing course; the [Ocean Way 2L Cube-inspired independent study](Projects/Technical-Audio-and-Research/Ocean-Way-Jazz-Combo-Dolby-Atmos-Independent-Study/README.md); [Vintage King Nashville Atmos training and listening events](https://vintageking.com/blog/vintage-kings-immersive-dolby-atmos-mixing-event/); and [Mix Nashville: Immersive Music Production](https://www.mixonline.com/events/inside-mix-nashville-immersive-music-production). Guided listening included Dolby Atmos material from [Emily Ann Roberts' release catalog](https://music.apple.com/us/artist/emily-ann-roberts/1040553354), including the documented Atmos version of [*The Building* mixed by Derek Bason](https://www.lovinlyrics.com/2023/02/emily-ann-roberts-releases-building.html).
- **Controlled-listening experience:** Participation as a listener in **unpublished** Belmont research and classroom exercises involving binaural rendering, horizontal image localization, anechoic-chamber loudspeaker localization, cochlear-bandpass perception, and drum-track phase alignment and polarity. Linked AES publications in the [detailed experience record](https://github.com/kevinworleymusic-afk/technical-ear-training/blob/main/PRIOR_EXPERIENCE.md) establish related faculty research context only; they do not contain or publish my data.
- **Measurement-informed listening:** [Audio Precision Studer validation](Projects/Technical-Audio-and-Research/Studer-A80-vs-A800-Plugin-Validation-Study/README.md), an unpublished [loudspeaker-versus-headphone frequency-boost study](Projects/Technical-Audio-and-Research/Loudspeaker-vs-Headphone-Frequency-Boost-Identification/README.md), room-response work, [MATLAB audio DSP](Projects/Coding-and-Audio-Software/MATLAB-Projects/README.md), and [Python audio analysis](https://github.com/kevinworleymusic-afk/audio-file-report).

Together, these experiences support describing me as a **trained and experienced critical listener** while the ear-training repository adds repeatable scoring, error tracking, and evidence of continued development.

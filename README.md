...
My primary direction is applied psychoacoustics and audio-systems development: connecting human perception and critical listening with acoustic measurement, electroacoustics, DSP, product tuning, and technical implementation. I am especially interested in cross-functional roles that translate among listeners, musicians and producers, acoustic and DSP engineers, product designers, and other stakeholders. Automotive and in-cabin audio are a leading application, alongside immersive and other electroacoustic systems; acoustical consulting remains a complementary path.
...
This experience supports critical listening, diagnosis against a reference, corrective feedback, communication, and team leadership. See my [prior background](https://github.com/kevinworleymusic-afk/technical-ear-training/blob/main/PRIOR_EXPERIENCE.md#relevant-background) and [Georgia employer tracker](https://docs.google.com/spreadsheets/d/1RuIrnG35fnQ2G6rblekq6ydcGVg35Rl4QB69DlzJnJY/edit).

## Critical Listening and Immersive Experience

My critical-listening development began with extensive [SoundGym practice](https://www.soundgym.co/member/profile?m=byy1s26wj7u), producing a 3,410,130 SPI and Diamond Ears Award. I then completed Jason Corey’s technical-ear-training work in class and have continued using that method for additional structured practice. The current [training record](https://github.com/kevinworleymusic-afk/technical-ear-training) contains 733 trials, including 97% across 30 two-band and 90% across 10 three-band EQ-matching trials, with task-specific limitations documented alongside the results.
...
## Career Direction: Applied Psychoacoustics and Audio Systems

I hold an M.S. in Audio Engineering from Belmont University and supported sessions for music recorded for EA Sports College Football 25. I am developing toward applied psychoacoustic and audio-systems roles that connect intended experience, human perception, objective measurement, and technical implementation.
...
Review the [career research dashboard](https://docs.google.com/spreadsheets/d/1RuIrnG35fnQ2G6rblekq6ydcGVg35Rl4QB69DlzJnJY/edit), [development syllabus](SYLLABUS.md), [generator/barrier project](Projects/Technical-Audio-and-Research/Generator-to-Residence-Barrier-Noise-Analysis/), [automotive roadmap](https://github.com/kevinworleymusic-afk/capture-to-reproduction-audio-study/blob/main/docs/Future-Projects/02_Automotive_Audio_Implementation_Roadmap.md), and [consulting calendar](Development-Calendar/Calendars/acoustical-consulting.md).

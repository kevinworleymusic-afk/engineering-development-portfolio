...
- **Controlled-listening experience:** Participation as a listener—not an author or co-author—in published AES studies involving binaural rendering and horizontal image localization, cochlear-bandpass perception, and drum-track phase alignment and polarity. I also completed additional anechoic-chamber loudspeaker-localization exercises. Publication links and exact role distinctions are documented in the [detailed experience record](https://github.com/kevinworleymusic-afk/technical-ear-training/blob/main/PRIOR_EXPERIENCE.md).

...
My primary direction is applied psychoacoustic engineering and audio-systems development: connecting human perception and critical listening with acoustic measurement, electroacoustics, DSP, product tuning, and technical implementation. I am especially interested in cross-functional roles that connect listener experience with perceptual research, acoustic and DSP engineering, product design, and validation. My music-education background supports that direction through experience translating complex listening concepts, adapting explanations for different audiences, diagnosing performance problems, and helping groups act on shared feedback. A consistent thread in my work is tracing a perceived result through the underlying system—acoustics, transducers, signal flow, DSP, measurement, and implementation—to understand why it occurs and how it can be improved. Automotive and in-cabin audio are a leading application, alongside immersive and other electroacoustic systems; acoustical consulting remains a complementary path.

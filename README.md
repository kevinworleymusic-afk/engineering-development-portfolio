...
Current work prioritizes the [Technical Listening Trainer prototype](https://github.com/kevinworleymusic-afk/technical-listening-trainer), structured listening practice, and automotive-audio study, supported by DSP, electronics, and a generator/barrier acoustics project. [View the current development calendar](Development-Calendar/).

## Professional Recommendations and Endorsements

Eight named recommendation and reference entries span seven professionals: six public recommendation letters, one public supervisor evaluation, and one job-specific reference-availability statement. Together they document education, musicianship, performance, reliability, communication, teamwork, technical aptitude, immersive-audio experience, and measurement work. [Sam Skelton’s jazz-performance recommendation](Professional-Evidence/Recommendations-and-Endorsements/01-music-education-performance-and-leadership/Sam-Skelton-Jazz-Performance-Recommendation-September-2025-Public.pdf) provides more than ten years of perspective on my development as a musician and professional. [Torey Harding’s privacy-redacted Starstruck internship evaluation](Professional-Evidence/Recommendations-and-Endorsements/03-studio-engineering-and-production/Torey-Harding-Starstruck-Internship-Evaluation-Fall-2023-Public.pdf) records 150 hours, perfect attendance, and an **Outstanding** overall rating. Dr. Doyuen Ko has indicated that he is open to considering a direct-to-employer recommendation for a specific role aligned with work he supervised; this records reference availability, not a publicly available general endorsement.
...
- **Acoustical consulting — [Generator-to-Residence Barrier Noise Analysis](Projects/Technical-Audio-and-Research/Generator-to-Residence-Barrier-Noise-Analysis/README.md):** Active project framework and calculation workbook; manufacturer-specific acoustic inputs, independent validation, and final conclusions remain incomplete.
...
- **Electronics — [Audio Electronics Fundamentals Workbook](Projects/Coding-and-Audio-Software/Audio-Electronics-Fundamentals-Workbook/README.md):** Structured study of components, analog signal flow, test equipment, troubleshooting, electrical safety, repair, and soldering foundations.
- **MATLAB — Audio DSP Fundamentals and Applications:** [Filtering and discrete-time systems](Projects/Coding-and-Audio-Software/MATLAB-Projects/MATLAB-Audio-DSP-Fundamentals/README.md); [distortion and audio analysis](Projects/Coding-and-Audio-Software/MATLAB-Projects/MATLAB-Distortion-and-Audio-Analysis/README.md); [convolution and tempo-synchronized delay](Projects/Coding-and-Audio-Software/MATLAB-Projects/MATLAB-Convolution-and-Tempo-Synchronized-Delay/README.md); and [nonlinear distortion with mid-side processing](Projects/Coding-and-Audio-Software/MATLAB-Projects/MATLAB-Nonlinear-Distortion-and-Mid-Side-Processing/README.md). Together these projects cover noise synthesis, FIR/IIR filtering, convolution, delay, waveshaping, clipping, harmonic processing, THD, and stereo/spatial techniques.

## Music Performance & Music Education Background

My Kennesaw State University background combined music performance, jazz study, ensemble work, and music education. [Sam Skelton’s jazz-performance recommendation](Professional-Evidence/Recommendations-and-Endorsements/01-music-education-performance-and-leadership/Sam-Skelton-Jazz-Performance-Recommendation-September-2025-Public.pdf) independently documents my musicianship, versatility, continued development, and work in professional musical environments. I student taught at Barber Middle School under Dr. Robert Grogan and Bradley Rikard, with additional pedagogy and leadership evidence in my [public letters and supporting materials](Professional-Evidence/Education-and-Leadership/README.md).
...
My prototype [Technical Listening Trainer](https://github.com/kevinworleymusic-afk/technical-listening-trainer) turns customizable, automotive-focused EQ exercises into blind trials with exportable analytics.
...
- [Completed and active project portfolio](#project-portfolio)
- [Technical Listening Trainer](https://github.com/kevinworleymusic-afk/technical-listening-trainer)
- [Current critical-listening record](https://github.com/kevinworleymusic-afk/technical-ear-training)
- [Audio File Report software repository](https://github.com/kevinworleymusic-afk/audio-file-report)
- [Professional recommendations and endorsements](Professional-Evidence/Recommendations-and-Endorsements/)
- [Current development calendar](Development-Calendar/)

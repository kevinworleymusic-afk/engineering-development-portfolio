...
My primary direction is applied psychoacoustic engineering and audio-systems development: connecting human perception and critical listening with acoustic measurement, electroacoustics, DSP, product tuning, and technical implementation. I am especially interested in cross-functional roles that translate among listeners and users, perceptual researchers, acoustic and DSP engineers, product designers, and validation teams. Automotive and in-cabin audio are a leading application, alongside immersive and other electroacoustic systems; acoustical consulting remains a complementary path.

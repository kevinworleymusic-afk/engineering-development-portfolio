...
- **Electronics foundations — [Coursework and development workbook](Projects/Coding-and-Audio-Software/Audio-Electronics-Fundamentals-Workbook/README.md):** Introductory studio-electronics study with Mike Porter covered circuit components, analog signal flow, test equipment, troubleshooting, electrical safety, repair, and soldering; the current workbook extends that foundation through planned calculation and simulation exercises.

...
Documented training includes a public [SoundGym profile](https://www.soundgym.co/member/profile?m=byy1s26wj7u) with a 3,410,130 SPI and Diamond Ears Award, plus 733 trials using Jason Corey’s course-based method. Recorded results include 97% across 30 two-band and 90% across 10 three-band EQ-matching trials, with task-specific limitations documented in the [training record](https://github.com/kevinworleymusic-afk/technical-ear-training).

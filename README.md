...
Relevant experience includes professional work at [Ocean Way Nashville](https://oceanwaynashville.com/) and [Starstruck Studios](https://www.starstruckentertainment.com/studios); guided work in 7.1.4 Dolby Atmos environments; the [Ocean Way immersive-recording independent study](Projects/Technical-Audio-and-Research/Ocean-Way-Jazz-Combo-Dolby-Atmos-Independent-Study/README.md); and participation as a listener—not an author—in published AES studies involving binaural localization, cochlear-bandpass perception, and drum-track phase and polarity. Together, this supports my continued development as a trained critical listener for spatial, loudspeaker, and automotive-audio applications.

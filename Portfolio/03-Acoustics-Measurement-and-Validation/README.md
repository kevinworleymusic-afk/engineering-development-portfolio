...
This portfolio view presents my work through an acoustics and test-engineering lens: room and environmental acoustics, electroacoustic/electronic measurement, signal analysis, validation planning, repeatability, uncertainty, and technical reporting.

## What this page is for

This page is intended for acoustics, electroacoustics, test, validation, measurement, and engineering-analysis roles.
...
The goal of this work is not simply to produce plots or single-number results. I aim to document stimulus and reference conditions, understand instrument and method limitations, separate observation from interpretation, preserve repeatability, and identify what additional measurement would be needed before making a stronger conclusion.

## Relevant automotive development functions

**Primary:** 03 Cabin Acoustics & Vehicle Noise, 08 Measurement & Validation

**Strong supporting functions:** 04 Audio Hardware & Packaging, 05 DSP & Sound Tuning, 09 Production Quality & Field Support, 10 Modeling/Data/Automation

## Current development priorities

- build repeatable in-vehicle measurement capability
- extend acoustical-analysis work toward vehicle cabins and vehicle noise
- strengthen objective/subjective correlation methods
- continue environmental-noise analysis and validation planning
- expand automation and data handling for repeatable test workflows
